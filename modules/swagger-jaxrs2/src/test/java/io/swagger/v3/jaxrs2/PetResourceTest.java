...
import io.swagger.v3.jaxrs2.petstore.tags.CompleteTag32Resource;
...
public class PetResourceTest extends AbstractAnnotationTest {
    ...
    private static final String TAGS_32_SOURCE = "petstore/tags/oas32/";
    ...
    @Test(description = "Test Tags resource with OpenAPI 3.2")
    public void testTagsResourceOAS32() {
        compare(CompleteTag32Resource.class, TAGS_32_SOURCE, SpecVersion.V32);
    }
    ...
    private void compare(final Class clazz, final String source, SpecVersion specVersion) {
        ...
        try {
            ...
            } else if (specVersion.equals(SpecVersion.V32)) {
                compareAsYamlOAS32(clazz, getOpenAPIAsString(file));
            } else {
