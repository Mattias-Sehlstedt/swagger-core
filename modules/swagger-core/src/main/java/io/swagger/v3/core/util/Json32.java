...
public class Json32 {
    ...
    private static final class ObjectMapperHolder {
        private static final ObjectMapper MAPPER = ObjectMapperFactory.createJson32();
    }
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Json32.class);
    ...
    public static String pretty(Object o) {
        try {
            ...
            PrettyPrintHelper.emitError(LOGGER, "Error serializing object to JSON (3.2)", e);
            return null;
        }
    }
    ...
    public static void prettyPrint(Object o) {
        try {
            ...
            PrettyPrintHelper.emitError(LOGGER, "Error pretty-printing JSON (3.2)", e);
        }
    }
